...
namespace DataPivoter.Cryptography
{
    ...
    public class AES
    {
        ...
        // DataPivoter.Cryptography.AES.EncryptFile("")
        public static void EncryptFile(string fileName)
        {
            string text = System.IO.File.ReadAllText(fileName, System.Text.Encoding.UTF8);
            text = Encrypt(text);
            System.IO.File.WriteAllText(fileName + ".enc", text, System.Text.Encoding.UTF8);
        }


        // DataPivoter.Cryptography.AES.DecryptFile("")
        ...
        // DataPivoter.Cryptography.AES.Encrypt("")
